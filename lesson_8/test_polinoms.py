import unittest
from polinoms import Polinom, DerivativeCalculate, StringModifier


class TestPolinom(unittest.TestCase):
    def setUp(self):
        self.polinom = Polinom("3x^2+x^2+4x+5x+1")
        self.polinom1 = Polinom("0x^3+4x")
        self.polinom2 = Polinom("20x^36+x^100")

    def test_dict(self):
        self.assertEqual(self.polinom.simplify(), {2: 4, 1: 9})
        self.assertEqual(self.polinom1.simplify(), {3: 0, 1: 4})
        self.assertEqual(self.polinom2.simplify(), {36: 20, 100: 1})

    def test_get_coefficient_power(self):
        self.assertEqual(self.polinom.get_coefficient_power(), [['3', '2'], [1, '2'], ['4', 1], ['5', 1]])
        self.assertEqual(self.polinom1.get_coefficient_power(), [['0', '3'], ['4', 1]])
        self.assertEqual(self.polinom2.get_coefficient_power(), [['20', '36'], [1, '100']])
